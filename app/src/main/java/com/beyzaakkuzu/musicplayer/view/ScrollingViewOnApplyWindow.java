...
public class ScrollingViewOnApplyWindow implements View.OnApplyWindowInsetsListener {
    ...
    public ScrollingViewOnApplyWindow(@Nullable View view,
    ...
    public ScrollingViewOnApplyWindow() {
        this(null, null);
    }
